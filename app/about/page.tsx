    ...
    <main style={{ background: '#000000', color: '#E6EDF3', minHeight: '100vh', width: '100%', fontFamily: 'ui-sans-serif, system-ui, sans-serif' }}>
      <div style={{ maxWidth: '40rem', margin: '0 auto', padding: '4rem 1.5rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'center' }}>
            {/* YouTube */}
            <a href="www.youtube.com/@KliqHub" target="_blank" rel="noopener noreferrer" aria-label="YouTube" style={{ color: '#8B98A5', transition: 'color 0.2s' }}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z" />
                <polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02" fill="currentColor" />
              </svg>
            </a><div style={{ marginTop: '2.5rem', borderTop: '1px solid #21262D', paddingTop: '1.5rem' }}>
          <p style={{ fontSize: '0.85rem', color: '#8B98A5', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '1rem' }}>
            Follow our ecosystem
          </p>
          <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'center' }}>
            {/* Instagram */}
            <a href="https://www.instagram.com/kliqhub" target="_blank" rel="noopener noreferrer" aria-label="Instagram" style={{ color: '#8B98A5', transition: 'color 0.2s' }}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            {/* TikTok */}
            <a href="hhttps://www.tiktok.com/@kliqhub" target="_blank" rel="noopener noreferrer" aria-label="TikTok" style={{ color: '#8B98A5', transition: 'color 0.2s' }}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
