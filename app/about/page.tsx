  ...
  return ( 
    <main style={{ background: '#000000', color: '#E6EDF3', minHeight: '100vh', width: '100%', fontFamily: 'ui-sans-serif, system-ui, sans-serif' }}> 
      <div style={{ maxWidth: '40rem', margin: '0 auto', padding: '4rem 1.5rem' }}> 
        ...
        <h1 style={{ fontSize: '2rem', fontWeight: 700, letterSpacing: '-0.02em', margin: 0 }}> About KliqHub </h1> 
        <p style={{ fontSize: '1rem', color: '#8B98A5', marginTop: '1.5rem', lineHeight: 1.8 }}> KliqHub is a free trust-layer scanner. Drop in an email, domain, phone number, or image, and get back a real-time Trust Score built from live security signal, not guesswork. </p> 
        <p style={{ fontSize: '1rem', color: '#8B98A5', marginTop: '1.25rem', lineHeight: 1.8 }}> We built KliqHub because verifying who and what you're dealing with online shouldn't require a dozen different tools. One check, one score, one clear answer. </p> 
        <p style={{ fontSize: '0.9rem', color: '#8B98A5', marginTop: '2.5rem' }}> Questions or partnership inquiries:{' '} <a href="mailto:hello@kliqhub.com" style={{ color: '#ADDFFF' }}> hello@kliqhub.com </a> </p> 
        
        {/* --- Social Links Section --- */} 
        <div style={{ marginTop: '2.5rem', borderTop: '1px solid #21262D', paddingTop: '1.5rem' }}> 
          <p style={{ fontSize: '0.85rem', color: '#8B98A5', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '1rem' }}> Follow our ecosystem </p> 
          <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'center' }}> 
            
            {/* YouTube */} 
            <a href="https://www.youtube.com/watch?v=qqfTEEgqREo&t=35s" target="_blank" rel="noopener noreferrer" aria-label="YouTube" style={{ color: '#8B98A5', transition: 'color 0.2s' }}> 
