    ...
    <main style={{ background: '#000000', color: '#E6EDF3', minHeight: '100vh', width: '100%', fontFamily: 'ui-sans-serif, system-ui, sans-serif' }}>
      <div style={{ maxWidth: '40rem', margin: '0 auto', padding: '4rem 1.5rem' }}>
        ...
        <p style={{ fontSize: '0.9rem', color: '#8B98A5', marginTop: '2.5rem' }}>
          ...
          <a href="mailto:hello@kliqhub.com" style={{ color: '#ADDFFF' }}>
            hello@kliqhub.com
          </a>
        </p>
          ...
          <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'center' }}>
            ...
            <a href="https://www.youtube.com/watch?v=qqfTEEgqREo&t=35s" target="_blank" rel="noopener noreferrer" aria-label="YouTube" style={{ color: '#8B98A5', transition: 'color 0.2s' }}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8[...]
